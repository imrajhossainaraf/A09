...
Write-Host "Removing old nested .git folders..."
Remove-Item -Recurse -Force "client\server\.git" -ErrorAction SilentlyContinue
Remove-Item -Recurse -Force "client\my-app\.git" -ErrorAction SilentlyContinue
...
Write-Host "Done! Root directory is now a single Git repository with all commits."
